...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "Alfred Updates [internal-only: Latest CC commits]" : "Alfred Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share Alfred and earn ${formatCreditAmount(reward)} of extra usage` : 'Share Alfred with friends';
  return {
