# Alfred for Non-Technical Users
...
Alfred lets you use an AI coding assistant with different model providers such as:
...
After you run `alfred`, the CLI should start and wait for your prompt.
