...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/alfred.proto')
...
const alfredProto = protoDescriptor.alfred.v1
...
async function main() {
  ...
  const client = new alfredProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mAlfred gRPC CLI\x1b[0m')
