...
Alfred is currently maintained on the latest `main` branch and the latest
npm release only.
...
If you believe you have found a security vulnerability in Alfred, please
report it privately.
...
- the Alfred source code in this repository
